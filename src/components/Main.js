...
const Main = () => {
    ...
    useEffect(() => {
        ...
        const getThings = async () =>{
            const tasksFromServer = await dataServer()
            console.log(tasksFromServer, "tambien del fetch")
          }
        ...
        const getPosts = async() => {
            ...
            /*let newo = [...allPosts, {
                "content": "no se que esta DDD",
                "file": "data:applicationK",
                "title": "holaK"
            }];*/
           // setPosts(newo);////////
           // console.log(newo)
